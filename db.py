...
if cho==1:
	...
	print(bar+'\n')
	time.sleep(0.5)
	print(f'\t{Style.BRIGHT}Use this to only get some fun \n\t     https://t.me/Tech_Wizard_Ent\n\t Based on TWE project[t.me/Tech_Wizard_Entertainment]' )
	print(bar+'\n')
	...
	print(bar+'\n')
	print("""
This Aplication developed by 🎭 Kavi_Ya 🎭 
[*] Authentication & all rights at (techwizardent.com)
A Product By 🎭 Kavi_Ya 🎭 ®(t.me/Kaveesha_Induwara)
""")
