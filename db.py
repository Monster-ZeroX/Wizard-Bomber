...
if cho==1:
	...
	print(bar+'\n')
	time.sleep(0.5)
	print(f'\t{Style.BRIGHT}Use this to only get some fun \n\t     https://t.me/Danuma_admin_bot\n\t Based on Danuma project[t.me/danuma01]' )
	print(bar+'\n')
	...
	print(bar+'\n')
	print("""
This Aplication developed by Lasiya
[*] Authentication & all rights at (t.me/danuma01)
A Product By Lasiya®(t.me/danuma01)
""")
